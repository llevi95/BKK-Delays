...
def _epoch(service_date, hms):
    ...
    midnight = pd.Timestamp(
        f"{service_date[:4]}-{service_date[4:6]}-{service_date[6:]}", tz=TZ
    )
...
def raw_df():
    ...
    return pd.DataFrame(
        [
            {
                "ingest_ts": "2026-06-23T06:00:00Z",
                "service_date": SD,
                "trip_id": "T1",
                "route_id": "R1",
                "stop_id": "S1",
                "stop_sequence": 1,
                "arrival_time": _epoch(SD, "08:00:00") + 30,
                "departure_time": _epoch(SD, "08:00:00") + 30,
                "schedule_relationship": 0,
            },
            {
                "ingest_ts": "2026-06-23T06:10:00Z",
                "service_date": SD,
                "trip_id": "T1",
                "route_id": "R1",
                "stop_id": "S2",
                "stop_sequence": 2,
                "arrival_time": _epoch(SD, "08:05:00") + 400,
                "departure_time": _epoch(SD, "08:05:00") + 400,
                "schedule_relationship": 0,
            },
            {
                "ingest_ts": "2026-06-23T07:00:00Z",
                "service_date": SD,
                "trip_id": "T2",
                "route_id": "R1",
                "stop_id": "S1",
                "stop_sequence": 1,
                "arrival_time": _epoch(SD, "09:00:00") + 60,
                "departure_time": None,
                "schedule_relationship": 0,
            },
        ]
